...
export default function Checkout({ 
  ...
  if (placedOrder) {
    return (
      <div className="order-success-wrap section-container max-w-2xl mx-auto py-16 px-6 mt-0">
  ...
  return (
    <>
      <div className="checkout-page-wrap section-container max-w-7xl mx-auto py-12 px-6 mt-0">
